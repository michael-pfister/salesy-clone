...
export default function SideMenu(props: {trialPeriod?: boolean, children: React.ReactNode, menuOpen: boolean }) {
    return <div className={`p-4 flex flex-col gap-4 bg-skyblue h-screen overflow-x-hidden ${!props.menuOpen && 'p-0'}`}>
